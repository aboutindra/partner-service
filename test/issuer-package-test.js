...
describe("Get issuer Package(s)", _ => {
...
describe("Delete issuer Package", _ => {
    ...
    it("Sending delete issuer package request with invalid package id (negative number)", done => {
        let PARAMS = -2;
        chai.request(server)
        .delete(BASE_URL + '/' + PARAMS)
        .end((error, response) => {
    ...
    it("Sending delete issuer package request with not exist package id", done => {
        let queryResult = {
            rowCount: 0,
            rows: []
        }
    ...
    it("Sending delete issuer package request with database connection failure", done => {
        sandbox.stub(pgPool.prototype, 'query').rejects();
    ...
    it("Sending delete issuer package request with valid package id", done => {
        let queryResult = {
            rowCount: 1,
            rows: []
        }
...
describe("Update issuer Package", _ => {
    ...
    it("Sending update issuer package request with invalid package name parameter (name already exist)", done => {
        let error = {
            code: '23505'
        }
    ...
    it("Sending update issuer package request with invalid cost type parameter (non existed type)", done => {
        let error = {
            code: '22P02'
        }
        sandbox.stub(pgPool.prototype, 'query').rejects(error);
    ...
    it("Sending update issuer package request with database connection failure", done => {
        sandbox.stub(pgPool.prototype, 'query').rejects();
    ...
    it("Sending update issuer package request with package not found response", done => {
        let queryResult = {
            rowCount: 0,
            rows: []
        }
    ...
    it("Sending update issuer package request with valid parameter", done => {
        let queryResult = {
            rowCount: 1,
            rows: []
        }
...
describe("Insert issuer Package", _ => {
    ...
    it("Sending insert issuer package request with invalid package name parameter (name already exist)", done => {
        let error = {
            code: '23505'
        }
        sandbox.stub(pgPool.prototype, 'query').rejects(error);
    ...
    it("Sending insert issuer package request with invalid cost type parameter (non existed type)", done => {
        let error = {
            code: '22P02'
        }
        sandbox.stub(pgPool.prototype, 'query').rejects(error);
    ...
    it("Sending insert issuer package request with database add row failure", done => {
        let queryResult = {
            rowCount: 0,
            rows: []
        }
    ...
    it("Sending insert issuer package request with valid parameter", done => {
        let queryResult = {
            rowCount: 1,
            rows: []
        }
